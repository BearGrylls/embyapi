...
> EditObjectContainer get_encoding_subtitleoptions()
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.SubtitleOptionsServiceApi(api_client)

    try:
        # Gets the subtitle options
        api_response = api_instance.get_encoding_subtitleoptions()
        print("The response of SubtitleOptionsServiceApi->get_encoding_subtitleoptions:\n")
        pprint(api_response)
