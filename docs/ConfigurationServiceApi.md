...
[**post_system_configuration_partial**](ConfigurationServiceApi.md#post_system_configuration_partial) | **POST** /System/Configuration/Partial | Updates application configuration


# **get_system_configuration**
> ServerConfiguration get_system_configuration()
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.ConfigurationServiceApi(api_client)

    try:
        # Gets application configuration
        api_response = api_instance.get_system_configuration()
        print("The response of ConfigurationServiceApi->get_system_configuration:\n")
        pprint(api_response)
...
|-------------|-------------|------------------|
**200** | Operation successful. Returning a ServerConfiguration object. |  -  |
...
> post_system_configuration(server_configuration)
...
with embyapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = embyapi.ConfigurationServiceApi(api_client)
    server_configuration = embyapi.ServerConfiguration() # ServerConfiguration | ServerConfiguration: 

    try:
        # Updates application configuration
        api_instance.post_system_configuration(server_configuration)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **server_configuration** | [**ServerConfiguration**](ServerConfiguration.md)| ServerConfiguration:  | 
...
> post_system_configuration_by_key(key, body)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates named configuration
        api_instance.post_system_configuration_by_key(key, body)
    except Exception as e:
...
# **post_system_configuration_partial**
> post_system_configuration_partial(server_configuration)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates application configuration
        api_instance.post_system_configuration_partial(server_configuration)
    except Exception as e:
        print("Exception when calling ConfigurationServiceApi->post_system_configuration_partial: %s\n" % e)
```
