...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.ScheduledTaskServiceApi(api_client)
    id = 'id_example' # str | 
...
# **get_scheduledtasks**
> List[TaskInfo] get_scheduledtasks(is_hidden=is_hidden, is_enabled=is_enabled)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ScheduledTaskServiceApi->get_scheduledtasks:\n")
        pprint(api_response)
    except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a TaskInfo[] object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
> TaskInfo get_scheduledtasks_by_id(id)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ScheduledTaskServiceApi->get_scheduledtasks_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
> post_scheduledtasks_by_id_triggers(id, task_trigger_info)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.ScheduledTaskServiceApi(api_client)
    id = 'id_example' # str | 
    task_trigger_info = [embyapi.TaskTriggerInfo()] # List[TaskTriggerInfo] | List`1: 

    try:
        # Updates the triggers for a scheduled task
        api_instance.post_scheduledtasks_by_id_triggers(id, task_trigger_info)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **id** | **str**|  | 
 **task_trigger_info** | [**List[TaskTriggerInfo]**](TaskTriggerInfo.md)| List&#x60;1:  | 
