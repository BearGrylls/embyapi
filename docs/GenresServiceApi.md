...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.GenresServiceApi(api_client)
    ...
    try:
        ...
        print("The response of GenresServiceApi->get_genres:\n")
        pprint(api_response)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GenresServiceApi->get_genres_by_name:\n")
        pprint(api_response)
    except Exception as e:
