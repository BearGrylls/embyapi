...
> EditObjectContainer get_encoding_fulltonemapoptions()
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.ToneMapOptionsServiceApi(api_client)

    try:
        # Gets the tone mapping options
        api_response = api_instance.get_encoding_fulltonemapoptions()
        print("The response of ToneMapOptionsServiceApi->get_encoding_fulltonemapoptions:\n")
        pprint(api_response)
...
> EditObjectContainer get_encoding_publictonemapoptions()
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ToneMapOptionsServiceApi->get_encoding_publictonemapoptions:\n")
        pprint(api_response)
    except Exception as e:
