...
> EditObjectContainer get_encoding_ffmpegoptions()
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.FfmpegOptionsServiceApi(api_client)

    try:
        # Gets the ffmpeg options
        api_response = api_instance.get_encoding_ffmpegoptions()
        print("The response of FfmpegOptionsServiceApi->get_encoding_ffmpegoptions:\n")
        pprint(api_response)
