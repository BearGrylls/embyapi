...
[**head_sync_jobitems_by_id_file**](SyncServiceApi.md#head_sync_jobitems_by_id_file) | **HEAD** /Sync/JobItems/{Id}/File | Gets a sync job item file
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.SyncServiceApi(api_client)
...
> List[SyncedItem] get_sync_items_ready(target_id)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SyncServiceApi->get_sync_items_ready:\n")
        pprint(api_response)
    except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a List&lt;SyncedItem&gt; object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
# **get_sync_jobitems**
> QueryResultSyncJobItem get_sync_jobitems(target_id)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets sync job items.
        api_response = api_instance.get_sync_jobitems(target_id)
        print("The response of SyncServiceApi->get_sync_jobitems:\n")
        pprint(api_response)
    except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a QueryResult&lt;SyncJobItem&gt; object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
# **get_sync_jobs**
> QueryResultSyncJob get_sync_jobs()
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SyncServiceApi->get_sync_jobs:\n")
        pprint(api_response)
    except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a QueryResult&lt;SyncJob&gt; object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
# **get_sync_jobs_by_id**
> SyncJob get_sync_jobs_by_id(id)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SyncServiceApi->get_sync_jobs_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a SyncJob object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
# **get_sync_options**
> SyncDialogOptions get_sync_options(user_id, item_ids=item_ids, parent_id=parent_id, target_id=target_id, category=category)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    category = embyapi.SyncCategory() # SyncCategory | Category (optional)
    ...
    try:
        ...
        print("The response of SyncServiceApi->get_sync_options:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **category** | [**SyncCategory**](.md)| Category | [optional] 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a SyncDialogOptions object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
# **get_sync_targets**
> List[SyncTarget] get_sync_targets(user_id)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SyncServiceApi->get_sync_targets:\n")
        pprint(api_response)
    except Exception as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a List&lt;SyncTarget&gt; object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
# **head_sync_jobitems_by_id_file**
> head_sync_jobitems_by_id_file(id)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets a sync job item file
        api_instance.head_sync_jobitems_by_id_file(id)
    except Exception as e:
        print("Exception when calling SyncServiceApi->head_sync_jobitems_by_id_file: %s\n" % e)
```
...
> post_sync_by_itemid_status(item_id, synced_item_progress)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    synced_item_progress = embyapi.SyncedItemProgress() # SyncedItemProgress | SyncedItemProgress: 

    try:
        # Gets sync status for an item.
        api_instance.post_sync_by_itemid_status(item_id, synced_item_progress)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **item_id** | **str**|  | 
 **synced_item_progress** | [**SyncedItemProgress**](SyncedItemProgress.md)| SyncedItemProgress:  | 
...
# **post_sync_data**
> SyncDataResponse post_sync_data(target_id, sync_data_request)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.SyncServiceApi(api_client)
    target_id = 'target_id_example' # str | TargetId
    sync_data_request = embyapi.SyncDataRequest() # SyncDataRequest | SyncDataRequest: 

    try:
        # Syncs data between device and server
        api_response = api_instance.post_sync_data(target_id, sync_data_request)
        print("The response of SyncServiceApi->post_sync_data:\n")
        pprint(api_response)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **target_id** | **str**| TargetId | 
 **sync_data_request** | [**SyncDataRequest**](SyncDataRequest.md)| SyncDataRequest:  | 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a SyncDataResponse object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
# **post_sync_jobs**
> SyncJobCreationResult post_sync_jobs(sync_job_request)
...
with embyapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = embyapi.SyncServiceApi(api_client)
    sync_job_request = embyapi.SyncJobRequest() # SyncJobRequest | SyncJobRequest: 

    try:
        # Gets sync jobs.
        api_response = api_instance.post_sync_jobs(sync_job_request)
        print("The response of SyncServiceApi->post_sync_jobs:\n")
        pprint(api_response)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sync_job_request** | [**SyncJobRequest**](SyncJobRequest.md)| SyncJobRequest:  | 
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Operation successful. Returning a SyncJobCreationResult object. |  -  |
**400** | Bad Request. Server cannot process request. |  -  |
**401** | Unauthorized. Client needs to authenticate. |  -  |
**403** | Forbidden. No permission for the reqested operation. |  -  |
**404** | Resource not found or unavailable. |  -  |
...
> post_sync_jobs_by_id(id, sync_job)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.SyncServiceApi(api_client)
    id = 56 # int | 
    sync_job = embyapi.SyncJob() # SyncJob | SyncJob: 

    try:
        # Updates a sync job.
        api_instance.post_sync_jobs_by_id(id, sync_job)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  | 
 **sync_job** | [**SyncJob**](SyncJob.md)| SyncJob:  | 
...
> post_sync_offlineactions(user_action)
...
with embyapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = embyapi.SyncServiceApi(api_client)
    user_action = [embyapi.UserAction()] # List[UserAction] | List`1: 

    try:
        # Reports an action that occurred while offline.
        api_instance.post_sync_offlineactions(user_action)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user_action** | [**List[UserAction]**](UserAction.md)| List&#x60;1:  | 
