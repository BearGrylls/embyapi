...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.MusicGenresServiceApi(api_client)
    ...
    try:
        ...
        print("The response of MusicGenresServiceApi->get_musicgenres:\n")
        pprint(api_response)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MusicGenresServiceApi->get_musicgenres_by_name:\n")
        pprint(api_response)
    except Exception as e:
