...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.StudiosServiceApi(api_client)
    ...
    try:
        ...
        print("The response of StudiosServiceApi->get_studios:\n")
        pprint(api_response)
...
with embyapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StudiosServiceApi->get_studios_by_name:\n")
        pprint(api_response)
    except Exception as e:
