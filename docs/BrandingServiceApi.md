...
with embyapi.ApiClient(configuration) as api_client:
    ...
    api_instance = embyapi.BrandingServiceApi(api_client)

    try:
        # Gets branding configuration
        api_response = api_instance.get_branding_configuration()
        print("The response of BrandingServiceApi->get_branding_configuration:\n")
        pprint(api_response)
...
|-------------|-------------|------------------|
**200** | Operation successful. Returning a BrandingOptions object. |  -  |
