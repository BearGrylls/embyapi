...
class PersistenceIntroDebugInfo(BaseModel):
    """
    ...
    start: Optional[StrictInt] = Field(default=None, alias="Start")
    end: Optional[StrictInt] = Field(default=None, alias="End")
    __properties: ClassVar[List[str]] = ["Id", "Path", "Start", "End"]
