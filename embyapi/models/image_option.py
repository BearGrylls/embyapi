...
class ImageOption(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="The limit.", alias="Limit")
    min_width: Optional[StrictInt] = Field(default=None, description="The minimum width.", alias="MinWidth")
