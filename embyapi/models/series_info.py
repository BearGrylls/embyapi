...
class SeriesInfo(BaseModel):
    ...
    SeriesInfo
    """ # noqa: E501
    episode_air_date: Optional[datetime] = Field(default=None, alias="EpisodeAirDate")
    display_order: Optional[SeriesDisplayOrder] = Field(default=None, alias="DisplayOrder")
    ...
    __properties: ClassVar[List[str]] = ["EpisodeAirDate", "DisplayOrder", "Name", "MetadataLanguage", "MetadataCountryCode", "MetadataLanguages", "ProviderIds", "Year", "IndexNumber", "ParentIndexNumber", "PremiereDate", "IsAutomated", "EnableAdultMetadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if episode_air_date (nullable) is None
        # and model_fields_set contains the field
        if self.episode_air_date is None and "episode_air_date" in self.model_fields_set:
            _dict['EpisodeAirDate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EpisodeAirDate": obj.get("EpisodeAirDate"),
