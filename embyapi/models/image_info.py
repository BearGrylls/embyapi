...
class ImageInfo(BaseModel):
    ...
    image_index: Optional[StrictInt] = Field(default=None, description="The index of the image.", alias="ImageIndex")
    ...
    size: Optional[StrictInt] = Field(default=None, description="The size.", alias="Size")
    __properties: ClassVar[List[str]] = ["ImageType", "ImageIndex", "Path", "Filename", "Height", "Width", "Size"]
