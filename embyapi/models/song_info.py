...
class SongInfo(BaseModel):
    ...
    composers: Optional[List[StrictStr]] = Field(default=None, alias="Composers")
    ...
    __properties: ClassVar[List[str]] = ["AlbumArtists", "Album", "Artists", "Composers", "Name", "MetadataLanguage", "MetadataCountryCode", "MetadataLanguages", "ProviderIds", "Year", "IndexNumber", "ParentIndexNumber", "PremiereDate", "IsAutomated", "EnableAdultMetadata"]
