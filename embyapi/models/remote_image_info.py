...
class RemoteImageInfo(BaseModel):
    ...
    """ # noqa: E501
    provider_name: Optional[StrictStr] = Field(default=None, description="The name of the provider.", alias="ProviderName")
    url: Optional[StrictStr] = Field(default=None, description="The URL.", alias="Url")
    thumbnail_url: Optional[StrictStr] = Field(default=None, description="A url used for previewing a smaller version", alias="ThumbnailUrl")
    height: Optional[StrictInt] = Field(default=None, description="The height.", alias="Height")
    width: Optional[StrictInt] = Field(default=None, description="The width.", alias="Width")
    ...
    vote_count: Optional[StrictInt] = Field(default=None, description="The vote count.", alias="VoteCount")
    language: Optional[StrictStr] = Field(default=None, description="The language.", alias="Language")
    ...
    __properties: ClassVar[List[str]] = ["ProviderName", "Url", "ThumbnailUrl", "Height", "Width", "CommunityRating", "VoteCount", "Language", "DisplayLanguage", "Type", "RatingType"]
