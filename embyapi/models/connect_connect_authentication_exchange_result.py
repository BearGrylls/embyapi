...
class ConnectConnectAuthenticationExchangeResult(BaseModel):
    """
    ConnectConnectAuthenticationExchangeResult
    """ # noqa: E501
    local_user_id: Optional[StrictStr] = Field(default=None, alias="LocalUserId")
    access_token: Optional[StrictStr] = Field(default=None, alias="AccessToken")
    __properties: ClassVar[List[str]] = ["LocalUserId", "AccessToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LocalUserId": obj.get("LocalUserId"),
