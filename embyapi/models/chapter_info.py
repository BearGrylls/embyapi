...
class ChapterInfo(BaseModel):
    ...
    Class ChapterInfo  
    """ # noqa: E501
    start_position_ticks: Optional[StrictInt] = Field(default=None, description="The start position ticks.", alias="StartPositionTicks")
    ...
    marker_type: Optional[MarkerType] = Field(default=None, alias="MarkerType")
    chapter_index: Optional[StrictInt] = Field(default=None, alias="ChapterIndex")
    __properties: ClassVar[List[str]] = ["StartPositionTicks", "Name", "ImageTag", "MarkerType", "ChapterIndex"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ChapterIndex": obj.get("ChapterIndex")
        })
        return _obj
