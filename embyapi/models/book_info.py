...
class BookInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["SeriesName", "Name", "MetadataLanguage", "MetadataCountryCode", "MetadataLanguages", "ProviderIds", "Year", "IndexNumber", "ParentIndexNumber", "PremiereDate", "IsAutomated", "EnableAdultMetadata"]
