...
class AuthenticationAuthenticationResult(BaseModel):
    """
    AuthenticationAuthenticationResult
    """ # noqa: E501
    user: Optional[UserDto] = Field(default=None, alias="User")
    session_info: Optional[SessionSessionInfo] = Field(default=None, alias="SessionInfo")
    access_token: Optional[StrictStr] = Field(default=None, description="The authentication token.", alias="AccessToken")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SessionInfo": SessionSessionInfo.from_dict(obj["SessionInfo"]) if obj.get("SessionInfo") is not None else None,
