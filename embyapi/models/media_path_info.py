...
class MediaPathInfo(BaseModel):
    ...
    network_path: Optional[StrictStr] = Field(default=None, alias="NetworkPath")
    ...
    __properties: ClassVar[List[str]] = ["Path", "NetworkPath", "Username", "Password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Path": obj.get("Path"),
            "NetworkPath": obj.get("NetworkPath"),
