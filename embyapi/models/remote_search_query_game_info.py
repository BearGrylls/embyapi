...
class RemoteSearchQueryGameInfo(BaseModel):
    ...
    """ # noqa: E501
    search_info: Optional[GameInfo] = Field(default=None, alias="SearchInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SearchInfo": GameInfo.from_dict(obj["SearchInfo"]) if obj.get("SearchInfo") is not None else None,
