...
class LiveTvKeywordInfo(BaseModel):
    """
    LiveTvKeywordInfo
    """ # noqa: E501
    keyword_type: Optional[LiveTvKeywordType] = Field(default=None, alias="KeywordType")
    keyword: Optional[StrictStr] = Field(default=None, alias="Keyword")
    __properties: ClassVar[List[str]] = ["KeywordType", "Keyword"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "KeywordType": obj.get("KeywordType"),
