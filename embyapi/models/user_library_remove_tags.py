...
class UserLibraryRemoveTags(BaseModel):
    """
    UserLibraryRemoveTags
    """ # noqa: E501
    tags: Optional[List[NameIdPair]] = Field(default=None, alias="Tags")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Tags": [NameIdPair.from_dict(_item) for _item in obj["Tags"]] if obj.get("Tags") is not None else None
        })
        return _obj
