...
class VirtualFolderInfo(BaseModel):
    ...
    locations: Optional[List[StrictStr]] = Field(default=None, description="The locations.", alias="Locations")
    ...
    id: Optional[StrictStr] = Field(default=None, description="ItemId came first, so that is left for compatability purposes", alias="Id")
    guid: Optional[StrictStr] = Field(default=None, alias="Guid")
    primary_image_item_id: Optional[StrictStr] = Field(default=None, description="The primary image item identifier.", alias="PrimaryImageItemId")
    ...
    __properties: ClassVar[List[str]] = ["Name", "Locations", "CollectionType", "LibraryOptions", "ItemId", "Id", "Guid", "PrimaryImageItemId", "RefreshProgress", "RefreshStatus"]
