...
class UITabPageInfo(BaseModel):
    ...
    nav_key: Optional[StrictStr] = Field(default=None, alias="NavKey")
    index: Optional[StrictInt] = Field(default=None, alias="Index")
    __properties: ClassVar[List[str]] = ["PageId", "DisplayName", "PluginId", "Href", "NavKey", "Index"]
