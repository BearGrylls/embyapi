...
class UserLibraryUpdateUserItemAccess(BaseModel):
    """
    ...
    item_access: Optional[UserItemShareLevel] = Field(default=None, alias="ItemAccess")
    __properties: ClassVar[List[str]] = ["ItemIds", "UserIds", "ItemAccess"]
