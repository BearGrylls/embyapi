...
class ApiNameIdDescriptionPair(BaseModel):
    """
    ApiNameIdDescriptionPair
    """ # noqa: E501
    short_overview: Optional[StrictStr] = Field(default=None, alias="ShortOverview")
    ...
    __properties: ClassVar[List[str]] = ["ShortOverview", "Name", "Id"]
