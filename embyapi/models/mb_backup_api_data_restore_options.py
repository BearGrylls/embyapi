...
class MBBackupApiDataRestoreOptions(BaseModel):
    """
    MBBackupApiDataRestoreOptions
    """ # noqa: E501
    users: Optional[List[MBBackupApiUserRestoreInfo]] = Field(default=None, alias="Users")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Users": [MBBackupApiUserRestoreInfo.from_dict(_item) for _item in obj["Users"]] if obj.get("Users") is not None else None
        })
        return _obj
