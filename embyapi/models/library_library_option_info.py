...
class LibraryLibraryOptionInfo(BaseModel):
    """
    ...
    features: Optional[List[MetadataFeatures]] = Field(default=None, alias="Features")
    __properties: ClassVar[List[str]] = ["Name", "SetupUrl", "DefaultEnabled", "Features"]
