...
class ValidatePath(BaseModel):
    ...
    ValidatePath
    """ # noqa: E501
    validate_writeable: Optional[StrictBool] = Field(default=None, alias="ValidateWriteable")
    ...
    __properties: ClassVar[List[str]] = ["ValidateWriteable", "IsFile", "Username", "Password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ValidateWriteable": obj.get("ValidateWriteable"),
