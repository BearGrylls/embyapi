...
class ProfileLevelInformation(BaseModel):
    ...
    """ # noqa: E501
    profile: Optional[ProfileInformation] = Field(default=None, alias="Profile")
    level: Optional[LevelInformation] = Field(default=None, alias="Level")
    __properties: ClassVar[List[str]] = ["Profile", "Level"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Profile": ProfileInformation.from_dict(obj["Profile"]) if obj.get("Profile") is not None else None,
            "Level": LevelInformation.from_dict(obj["Level"]) if obj.get("Level") is not None else None
        })
        return _obj
