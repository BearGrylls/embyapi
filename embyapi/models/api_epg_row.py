...
class ApiEpgRow(BaseModel):
    """
    ApiEpgRow
    """ # noqa: E501
    channel: Optional[BaseItemDto] = Field(default=None, alias="Channel")
    programs: Optional[List[BaseItemDto]] = Field(default=None, alias="Programs")
    __properties: ClassVar[List[str]] = ["Channel", "Programs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Channel": BaseItemDto.from_dict(obj["Channel"]) if obj.get("Channel") is not None else None,
            "Programs": [BaseItemDto.from_dict(_item) for _item in obj["Programs"]] if obj.get("Programs") is not None else None
        })
        return _obj
