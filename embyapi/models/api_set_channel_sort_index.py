...
class ApiSetChannelSortIndex(BaseModel):
    """
    ApiSetChannelSortIndex
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="Id")
    management_id: Optional[StrictStr] = Field(default=None, alias="ManagementId")
    new_index: Optional[StrictInt] = Field(default=None, alias="NewIndex")
    __properties: ClassVar[List[str]] = ["Id", "ManagementId", "NewIndex"]
