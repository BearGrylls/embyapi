...
class MetadataEditorInfo(BaseModel):
    ...
    countries: Optional[List[GlobalizationCountryInfo]] = Field(default=None, alias="Countries")
    cultures: Optional[List[GlobalizationCultureDto]] = Field(default=None, alias="Cultures")
    external_id_infos: Optional[List[ExternalIdInfo]] = Field(default=None, alias="ExternalIdInfos")
    __properties: ClassVar[List[str]] = ["ParentalRatingOptions", "Countries", "Cultures", "ExternalIdInfos"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.parental_rating_options:
            for _item in self.parental_rating_options:
                if _item:
        ...
        if self.external_id_infos:
            for _item in self.external_id_infos:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Countries": [GlobalizationCountryInfo.from_dict(_item) for _item in obj["Countries"]] if obj.get("Countries") is not None else None,
            "Cultures": [GlobalizationCultureDto.from_dict(_item) for _item in obj["Cultures"]] if obj.get("Cultures") is not None else None,
