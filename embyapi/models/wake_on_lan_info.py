...
class WakeOnLanInfo(BaseModel):
    ...
    broadcast_address: Optional[StrictStr] = Field(default=None, alias="BroadcastAddress")
    port: Optional[StrictInt] = Field(default=None, alias="Port")
    __properties: ClassVar[List[str]] = ["MacAddress", "BroadcastAddress", "Port"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BroadcastAddress": obj.get("BroadcastAddress"),
            "Port": obj.get("Port")
        })
        return _obj
