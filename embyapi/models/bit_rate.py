...
class BitRate(BaseModel):
    ...
    """ # noqa: E501
    bps: Optional[StrictInt] = None
    kbps: Optional[Union[StrictFloat, StrictInt]] = None
    mbps: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="Mbps")
    __properties: ClassVar[List[str]] = ["bps", "kbps", "Mbps"]
