...
class RemoteSearchQueryItemLookupInfo(BaseModel):
    ...
    """ # noqa: E501
    search_info: Optional[ItemLookupInfo] = Field(default=None, alias="SearchInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SearchInfo": ItemLookupInfo.from_dict(obj["SearchInfo"]) if obj.get("SearchInfo") is not None else None,
