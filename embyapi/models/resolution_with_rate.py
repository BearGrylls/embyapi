...
class ResolutionWithRate(BaseModel):
    ...
    """ # noqa: E501
    width: Optional[StrictInt] = Field(default=None, description="The resolution width.", alias="Width")
    height: Optional[StrictInt] = Field(default=None, description="The resolution height.", alias="Height")
    frame_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The frame rate in frames/second (fps).", alias="FrameRate")
    resolution: Optional[Resolution] = Field(default=None, alias="Resolution")
    __properties: ClassVar[List[str]] = ["Width", "Height", "FrameRate", "Resolution"]
