...
class MBBackupApiUserRestoreInfo(BaseModel):
    """
    MBBackupApiUserRestoreInfo
    """ # noqa: E501
    source_user_id: Optional[StrictStr] = Field(default=None, alias="SourceUserId")
    target_user_id: Optional[StrictStr] = Field(default=None, alias="TargetUserId")
    __properties: ClassVar[List[str]] = ["SourceUserId", "TargetUserId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SourceUserId": obj.get("SourceUserId"),
