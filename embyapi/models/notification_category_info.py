...
class NotificationCategoryInfo(BaseModel):
    ...
    events: Optional[List[NotificationTypeInfo]] = Field(default=None, alias="Events")
    __properties: ClassVar[List[str]] = ["Name", "Id", "Events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Name": obj.get("Name"),
            "Id": obj.get("Id"),
            "Events": [NotificationTypeInfo.from_dict(_item) for _item in obj["Events"]] if obj.get("Events") is not None else None
        })
        return _obj
