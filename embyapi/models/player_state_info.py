...
class PlayerStateInfo(BaseModel):
    ...
    PlayerStateInfo
    """ # noqa: E501
    position_ticks: Optional[StrictInt] = Field(default=None, description="The now playing position ticks.", alias="PositionTicks")
    ...
    audio_stream_index: Optional[StrictInt] = Field(default=None, description="The index of the now playing audio stream.", alias="AudioStreamIndex")
    subtitle_stream_index: Optional[StrictInt] = Field(default=None, description="The index of the now playing subtitle stream.", alias="SubtitleStreamIndex")
    media_source_id: Optional[StrictStr] = Field(default=None, description="The now playing media version identifier.", alias="MediaSourceId")
    ...
    __properties: ClassVar[List[str]] = ["PositionTicks", "CanSeek", "IsPaused", "IsMuted", "VolumeLevel", "AudioStreamIndex", "SubtitleStreamIndex", "MediaSourceId", "PlayMethod", "RepeatMode", "SubtitleOffset", "PlaybackRate"]
