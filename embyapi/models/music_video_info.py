...
class MusicVideoInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Artists", "Name", "MetadataLanguage", "MetadataCountryCode", "MetadataLanguages", "ProviderIds", "Year", "IndexNumber", "ParentIndexNumber", "PremiereDate", "IsAutomated", "EnableAdultMetadata"]
