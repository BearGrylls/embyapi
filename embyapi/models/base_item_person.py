...
class BaseItemPerson(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default=None, description="The role.", alias="Role")
    type: Optional[PersonType] = Field(default=None, alias="Type")
    primary_image_tag: Optional[StrictStr] = Field(default=None, description="The primary image tag.", alias="PrimaryImageTag")
    __properties: ClassVar[List[str]] = ["Name", "Id", "Role", "Type", "PrimaryImageTag"]
