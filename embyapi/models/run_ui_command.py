...
class RunUICommand(BaseModel):
    ...
    client_locale: Optional[StrictStr] = Field(default=None, alias="ClientLocale")
    __properties: ClassVar[List[str]] = ["PageId", "CommandId", "Data", "ItemId", "ClientLocale"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ClientLocale": obj.get("ClientLocale")
        })
        return _obj
