...
class RokuMetadataApiThumbnailSetInfo(BaseModel):
    """
    RokuMetadataApiThumbnailSetInfo
    """ # noqa: E501
    aspect_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="AspectRatio")
    thumbnails: Optional[List[RokuMetadataApiThumbnailInfo]] = Field(default=None, alias="Thumbnails")
    __properties: ClassVar[List[str]] = ["AspectRatio", "Thumbnails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Thumbnails": [RokuMetadataApiThumbnailInfo.from_dict(_item) for _item in obj["Thumbnails"]] if obj.get("Thumbnails") is not None else None
        })
        return _obj
