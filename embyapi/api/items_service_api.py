...
class ItemsServiceApi:
    ...
    def get_users_by_userid_items(
        ...
        _param = self._get_users_by_userid_items_serialize(
            user_id=user_id,
            artist_type=artist_type,
            max_official_rating=max_official_rating,
            has_theme_song=has_theme_song,
    ...
    @validate_call
    def get_users_by_userid_items_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
    ...
    @validate_call
    def get_users_by_userid_items_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
    ...
    def _get_users_by_userid_items_serialize(
        self,
        user_id,
        artist_type,
        max_official_rating,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Users/{UserId}/Items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_users_by_userid_items_resume(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        ...
        _param = self._get_users_by_userid_items_resume_serialize(
            user_id=user_id,
            artist_type=artist_type,
            max_official_rating=max_official_rating,
            has_theme_song=has_theme_song,
    ...
    @validate_call
    def get_users_by_userid_items_resume_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
    ...
    @validate_call
    def get_users_by_userid_items_resume_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
    ...
    def _get_users_by_userid_items_resume_serialize(
        self,
        user_id,
        artist_type,
        max_official_rating,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Users/{UserId}/Items/Resume',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
