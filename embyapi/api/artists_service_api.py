...
class ArtistsServiceApi:
    ...
    def get_artists_albumartists(
        ...
        _param = self._get_artists_albumartists_serialize(
            artist_type=artist_type,
            max_official_rating=max_official_rating,
            has_theme_song=has_theme_song,
            has_theme_video=has_theme_video,
    ...
    @validate_call
    def get_artists_albumartists_with_http_info(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    @validate_call
    def get_artists_albumartists_without_preload_content(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    def _get_artists_albumartists_serialize(
        self,
        artist_type,
        max_official_rating,
        has_theme_song,
    ...
    def get_artists_by_name(
        self,
        name: Annotated[StrictStr, Field(description="The artist name")],
        ...
        _param = self._get_artists_by_name_serialize(
            name=name,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_artists_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The artist name")],
        user_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by user id, and attach user data")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_artists_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The artist name")],
        user_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by user id, and attach user data")] = None,
        _request_timeout: Union[
    ...
    def _get_artists_by_name_serialize(
        self,
        name,
        user_id,
        _request_auth,
