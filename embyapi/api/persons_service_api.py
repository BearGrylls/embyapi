...
class PersonsServiceApi:
    ...
    def get_persons_by_name(
        self,
        name: Annotated[StrictStr, Field(description="The person name")],
        ...
        _param = self._get_persons_by_name_serialize(
            name=name,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_persons_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The person name")],
        user_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by user id, and attach user data")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_persons_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The person name")],
        user_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by user id, and attach user data")] = None,
        _request_timeout: Union[
    ...
    def _get_persons_by_name_serialize(
        self,
        name,
        user_id,
        _request_auth,
