...
class TvShowsServiceApi:
    ...
    @validate_call
    def get_shows_by_id_episodes(
        self,
        id: Annotated[StrictStr, Field(description="The series id")],
        ...
        _param = self._get_shows_by_id_episodes_serialize(
            id=id,
            season=season,
            season_id=season_id,
    ...
    @validate_call
    def get_shows_by_id_episodes_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The series id")],
        season: Annotated[Optional[StrictInt], Field(description="Optional filter by season number.")] = None,
        season_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by season id")] = None,
    ...
    @validate_call
    def get_shows_by_id_episodes_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The series id")],
        season: Annotated[Optional[StrictInt], Field(description="Optional filter by season number.")] = None,
        season_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by season id")] = None,
    ...
    def _get_shows_by_id_episodes_serialize(
        self,
        id,
        season,
        season_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Shows/{Id}/Episodes',
    ...
    def get_shows_by_id_seasons(
        ...
        _param = self._get_shows_by_id_seasons_serialize(
            user_id=user_id,
            id=id,
            fields=fields,
    ...
    @validate_call
    def get_shows_by_id_seasons_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        id: Annotated[StrictStr, Field(description="The series id")],
        fields: Annotated[Optional[StrictStr], Field(description="Optional. Specify additional fields of information to return in the output. This allows multiple, comma delimeted. Options: Budget, Chapters, DateCreated, Genres, HomePageUrl, IndexOptions, MediaStreams, Overview, ParentId, Path, People, ProviderIds, PrimaryImageAspectRatio, Revenue, SortName, Studios, Taglines, TrailerUrls")] = None,
    ...
    @validate_call
    def get_shows_by_id_seasons_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        id: Annotated[StrictStr, Field(description="The series id")],
        fields: Annotated[Optional[StrictStr], Field(description="Optional. Specify additional fields of information to return in the output. This allows multiple, comma delimeted. Options: Budget, Chapters, DateCreated, Genres, HomePageUrl, IndexOptions, MediaStreams, Overview, ParentId, Path, People, ProviderIds, PrimaryImageAspectRatio, Revenue, SortName, Studios, Taglines, TrailerUrls")] = None,
    ...
    def _get_shows_by_id_seasons_serialize(
        self,
        user_id,
        id,
        fields,
    ...
    def get_shows_missing(
        ...
        _param = self._get_shows_missing_serialize(
            artist_type=artist_type,
            max_official_rating=max_official_rating,
            has_theme_song=has_theme_song,
            has_theme_video=has_theme_video,
    ...
    @validate_call
    def get_shows_missing_with_http_info(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    @validate_call
    def get_shows_missing_without_preload_content(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    def _get_shows_missing_serialize(
        self,
        artist_type,
        max_official_rating,
        has_theme_song,
    ...
    def get_shows_nextup(
        ...
        _param = self._get_shows_nextup_serialize(
            user_id=user_id,
            start_index=start_index,
            limit=limit,
            fields=fields,
    ...
    @validate_call
    def get_shows_nextup_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        start_index: Annotated[Optional[StrictInt], Field(description="Optional. The record index to start at. All items with a lower index will be dropped from the results.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of records to return")] = None,
    ...
    @validate_call
    def get_shows_nextup_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="User Id")],
        start_index: Annotated[Optional[StrictInt], Field(description="Optional. The record index to start at. All items with a lower index will be dropped from the results.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of records to return")] = None,
    ...
    def _get_shows_nextup_serialize(
        self,
        user_id,
        start_index,
        limit,
    ...
    def get_shows_upcoming(
        ...
        _param = self._get_shows_upcoming_serialize(
            artist_type=artist_type,
            max_official_rating=max_official_rating,
            has_theme_song=has_theme_song,
            has_theme_video=has_theme_video,
    ...
    @validate_call
    def get_shows_upcoming_with_http_info(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    @validate_call
    def get_shows_upcoming_without_preload_content(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    def _get_shows_upcoming_serialize(
        self,
        artist_type,
        max_official_rating,
        has_theme_song,
