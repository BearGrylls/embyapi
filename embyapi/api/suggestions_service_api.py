...
class SuggestionsServiceApi:
    ...
    @validate_call
    def get_users_by_userid_suggestions(
        self,
        user_id: StrictStr,
        ...
        _param = self._get_users_by_userid_suggestions_serialize(
            user_id=user_id,
            fields=fields,
    ...
    @validate_call
    def get_users_by_userid_suggestions_with_http_info(
        self,
        user_id: StrictStr,
        fields: Annotated[Optional[StrictStr], Field(description="Optional. Specify additional fields of information to return in the output. This allows multiple, comma delimeted. Options: Budget, Chapters, DateCreated, Genres, HomePageUrl, IndexOptions, MediaStreams, Overview, ParentId, Path, People, ProviderIds, PrimaryImageAspectRatio, Revenue, SortName, Studios, Taglines, TrailerUrls")] = None,
        enable_images: Annotated[Optional[StrictBool], Field(description="Optional, include image information in output")] = None,
    ...
    @validate_call
    def get_users_by_userid_suggestions_without_preload_content(
        self,
        user_id: StrictStr,
        fields: Annotated[Optional[StrictStr], Field(description="Optional. Specify additional fields of information to return in the output. This allows multiple, comma delimeted. Options: Budget, Chapters, DateCreated, Genres, HomePageUrl, IndexOptions, MediaStreams, Overview, ParentId, Path, People, ProviderIds, PrimaryImageAspectRatio, Revenue, SortName, Studios, Taglines, TrailerUrls")] = None,
        enable_images: Annotated[Optional[StrictBool], Field(description="Optional, include image information in output")] = None,
    ...
    def _get_users_by_userid_suggestions_serialize(
        self,
        user_id,
        fields,
        enable_images,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Users/{UserId}/Suggestions',
