...
class ActivityLogServiceApi:
    ...
    @validate_call
    def get_system_activitylog_entries(
        self,
        ...
        min_date: Annotated[Optional[StrictStr], Field(description="Optional. The minimum date. Format = ISO")] = None,
        ...
        _param = self._get_system_activitylog_entries_serialize(
    ...
    @validate_call
    def get_system_activitylog_entries_with_http_info(
        self,
        start_index: Annotated[Optional[StrictInt], Field(description="Optional. The record index to start at. All items with a lower index will be dropped from the results.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of records to return")] = None,
        min_date: Annotated[Optional[StrictStr], Field(description="Optional. The minimum date. Format = ISO")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QueryResultActivityLogEntry]:
        """Gets activity log entries
    ...
    @validate_call
    def get_system_activitylog_entries_without_preload_content(
        self,
        start_index: Annotated[Optional[StrictInt], Field(description="Optional. The record index to start at. All items with a lower index will be dropped from the results.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Optional. The maximum number of records to return")] = None,
        min_date: Annotated[Optional[StrictStr], Field(description="Optional. The minimum date. Format = ISO")] = None,
    ...
    def _get_system_activitylog_entries_serialize(
        self,
        start_index,
        limit,
        min_date,
