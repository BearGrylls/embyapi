...
class MusicGenresServiceApi:
    ...
    def get_musicgenres(
        ...
        _param = self._get_musicgenres_serialize(
    ...
    @validate_call
    def get_musicgenres_with_http_info(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    @validate_call
    def get_musicgenres_without_preload_content(
        self,
        artist_type: Annotated[Optional[StrictStr], Field(description="Artist or AlbumArtist")] = None,
        max_official_rating: Annotated[Optional[StrictStr], Field(description="Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).")] = None,
        has_theme_song: Annotated[Optional[StrictBool], Field(description="Optional filter by items with theme songs.")] = None,
    ...
    def _get_musicgenres_serialize(
        self,
        artist_type,
        max_official_rating,
        has_theme_song,
    ...
    def get_musicgenres_by_name(
        ...
        _param = self._get_musicgenres_by_name_serialize(
            name=name,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_musicgenres_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The genre name")],
        user_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by user id, and attach user data")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_musicgenres_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The genre name")],
        user_id: Annotated[Optional[StrictStr], Field(description="Optional. Filter by user id, and attach user data")] = None,
        _request_timeout: Union[
    ...
    def _get_musicgenres_by_name_serialize(
        self,
        name,
        user_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/MusicGenres/{Name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
