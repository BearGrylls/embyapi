...
class TestApiEpgRow(unittest.TestCase):
    """ApiEpgRow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiEpgRow:
        """Test ApiEpgRow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiEpgRow`
        """
        model = ApiEpgRow()
        if include_optional:
            return ApiEpgRow(
