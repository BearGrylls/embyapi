...
class TestLiveStreamRequest(unittest.TestCase):
    """LiveStreamRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiveStreamRequest:
        """Test LiveStreamRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiveStreamRequest`
        """
    ...
    def testLiveStreamRequest(self):
        """Test LiveStreamRequest"""
