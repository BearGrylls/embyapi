...
class TestLibraryUpdateLibraryOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LibraryUpdateLibraryOptions:
        """Test LibraryUpdateLibraryOptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LibraryUpdateLibraryOptions`
        """
        model = LibraryUpdateLibraryOptions()
        if include_optional:
            return LibraryUpdateLibraryOptions(
                id = '',
