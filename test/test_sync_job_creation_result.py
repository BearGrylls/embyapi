...
class TestSyncJobCreationResult(unittest.TestCase):
    """SyncJobCreationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncJobCreationResult:
        """Test SyncJobCreationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncJobCreationResult`
        """
        model = SyncJobCreationResult()
        if include_optional:
            return SyncJobCreationResult(
                job = embyapi.models.sync_job.SyncJob(
                    id = 56, 
                    target_id = '', 
                    ...
                    primary_image_tag = '', ),
                job_items = [
                    embyapi.models.sync_job_item.SyncJobItem(
                        id = 56, 
                        job_id = 56, 
                        item_id = 56, 
                        item_name = '', 
    ...
    def testSyncJobCreationResult(self):
        """Test SyncJobCreationResult"""
