...
class TestSyncedItem(unittest.TestCase):
    """SyncedItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncedItem:
        """Test SyncedItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncedItem`
        """
        model = SyncedItem()
        if include_optional:
            return SyncedItem(
                ...
                sync_job_id = 56,
                sync_job_name = '',
                sync_job_date_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                sync_job_item_id = 56,
                original_file_name = '',
                item = embyapi.models.base_item_dto.BaseItemDto(
                    name = '', 
                    original_title = '', 
                    server_id = '', 
                    id = '', 
                ...
                user_id = '',
                additional_files = [
                    embyapi.models.item_file_info.ItemFileInfo(
                        type = 'Media', 
                        name = '', 
                        path = '', 
                        image_type = 'Primary', 
