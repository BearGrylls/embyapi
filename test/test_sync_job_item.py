...
class TestSyncJobItem(unittest.TestCase):
    """SyncJobItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncJobItem:
        """Test SyncJobItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncJobItem`
        """
        model = SyncJobItem()
        if include_optional:
            return SyncJobItem(
