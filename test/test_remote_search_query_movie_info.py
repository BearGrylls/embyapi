...
class TestRemoteSearchQueryMovieInfo(unittest.TestCase):
    """RemoteSearchQueryMovieInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoteSearchQueryMovieInfo:
        """Test RemoteSearchQueryMovieInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteSearchQueryMovieInfo`
        """
        model = RemoteSearchQueryMovieInfo()
        if include_optional:
            return RemoteSearchQueryMovieInfo(
                search_info = embyapi.models.movie_info.MovieInfo(
                    name = '', 
                    metadata_language = '', 
    ...
    def testRemoteSearchQueryMovieInfo(self):
        """Test RemoteSearchQueryMovieInfo"""
