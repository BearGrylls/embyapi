...
class TestQueryResultVirtualFolderInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QueryResultVirtualFolderInfo:
        """Test QueryResultVirtualFolderInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryResultVirtualFolderInfo`
        """
        model = QueryResultVirtualFolderInfo()
        if include_optional:
            return QueryResultVirtualFolderInfo(
                items = [
                    embyapi.models.virtual_folder_info.VirtualFolderInfo(
                        name = '', 
                        locations = [
                            ''
                            ], 
