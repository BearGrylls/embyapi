...
class TestQueryResultApiEpgRow(unittest.TestCase):
    """QueryResultApiEpgRow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryResultApiEpgRow:
        """Test QueryResultApiEpgRow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryResultApiEpgRow`
        """
        model = QueryResultApiEpgRow()
        if include_optional:
            return QueryResultApiEpgRow(
                items = [
                    embyapi.models.api/epg_row.Api.EpgRow(
                        channel = embyapi.models.base_item_dto.BaseItemDto(
                            name = '', 
                            original_title = '', 
                            server_id = '', 
                            id = '', 
    ...
    def testQueryResultApiEpgRow(self):
        """Test QueryResultApiEpgRow"""
