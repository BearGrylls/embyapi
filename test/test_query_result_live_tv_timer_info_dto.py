...
class TestQueryResultLiveTvTimerInfoDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QueryResultLiveTvTimerInfoDto:
        """Test QueryResultLiveTvTimerInfoDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryResultLiveTvTimerInfoDto`
        """
        model = QueryResultLiveTvTimerInfoDto()
        if include_optional:
            return QueryResultLiveTvTimerInfoDto(
                items = [
                    embyapi.models.live_tv/timer_info_dto.LiveTv.TimerInfoDto(
                        status = 'New', 
                        series_timer_id = '', 
                        run_time_ticks = 56, 
                        program_info = embyapi.models.base_item_dto.BaseItemDto(
                            name = '', 
                            original_title = '', 
                            server_id = '', 
                            id = '', 
